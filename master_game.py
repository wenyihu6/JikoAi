...
def main():
    ...
    EggHatchedBala = GIFImage("graphicAssets/EggHatchedBala", WIDTH/4 + 80, HEIGHT/2 - 170, 5)
    EggHatchedBala.resize(250, 250)

    EggHatchedMamau = GIFImage("graphicAssets/EggHatchedMamau", WIDTH/4 + 80, HEIGHT/2 - 170, 5)
    EggHatchedMamau.resize(250, 250)

    EggHatchedTora = GIFImage("graphicAssets/EggHatchedTora", WIDTH/4 + 80, HEIGHT/2 - 170, 5)
    EggHatchedTora.resize(250, 250)
    ...
    while True:
        ...
        if currGameState == Screen.STARTING:
            ...
            if petSum <= 6:
                ...
                currPet = Pet.init_gifImage(PetType.BALAGIF, "mamau")
            else:
                homeBG.animate(screen)
                EggHatchedTora.animate(screen)
                currPet = Pet.init_gifImage(PetType.BALAGIF, "tora")
