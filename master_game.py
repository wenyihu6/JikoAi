...
def main():
    ...
    while True:
        ...
        if currGameState == Screen.STARTING:
            ...
            homeButton = Button(screen, 200, 200, 100, 100, function = 0, color = (233, 255, 255), hover_color = (454, 255, 255), border= True, border_width = 2, border_colour = (0, 0, 0), txt= True, text ='dfdf', font_name = 'arial', text_size = 20, text_color = (0, 0, 0), check_bold= True)
            homeButton.draw()
            homeButton.mouse_hovering()
            homeButton.update()
            homeButton.show_text()
            homeButton.click()
